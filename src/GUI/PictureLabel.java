...
public class PictureLabel extends JLabel {
	...
	public class ThumbnailMouseListener extends MouseAdapter {
		...
		/**
		 * Incomlete picture selection method. Ideally a 2D array should store
		 * all labels and enable moving between thumbnails using arrow keys and
		 * viewing a single image using spacebar. Additionally only one picture
		 * should be selected at one time unless mouse is dragged across
		 * pictures or ctrl key is held. Good luck with that.
		 */
		@Override
